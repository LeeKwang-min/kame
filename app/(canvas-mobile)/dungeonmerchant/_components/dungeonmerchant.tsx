...
import { setupDungeonMerchant, TDungeonMerchantCallbacks } from '../_lib/game';
...
function DungeonMerchant() {
  ...
  const { mutateAsync: saveScore } = useCreateScore('dungeonmerchant');
  const { mutateAsync: createSession } = useGameSession('dungeonmerchant');
  ...
  useEffect(() => {
    ...
    const callbacks: TDungeonMerchantCallbacks = {
      onGameStart: async () => {
        try {
    ...
    return setupDungeonMerchant(canvas, callbacks);
...
export default DungeonMerchant;
