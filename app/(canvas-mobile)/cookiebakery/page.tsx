...
import CookieBakery from './_components/cookiebakery';
...
function CookieBakeryPage() {
  const { data: session, status } = useSession();
  const { data: scores = [], isLoading } = useGetScores('cookiebakery');
...
export default CookieBakeryPage;
