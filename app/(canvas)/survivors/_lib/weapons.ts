...
export const WEAPON_DEFS: Record<TWeaponId, TWeaponDef> = {
  magic_wand: {
    ...
    evolvedName: '성스러운 지팡이',
  },
  knife: {
    id: 'knife',
    name: '단검',
    description: '바라보는 방향으로 단검을 던진다.',
    baseCooldown: 0.8,
    baseDamage: 8,
    baseProjectiles: 1,
    evolvesWith: 'bracer',
  ...
  axe: {
    id: 'axe',
    name: '도끼',
    description: '위로 던져 중력에 의해 떨어지는 도끼.',
    baseCooldown: 1.5,
    baseDamage: 20,
    baseProjectiles: 1,
    evolvesWith: 'candelabrador',
    evolvesInto: 'death_spiral',
    evolvedName: '죽음의 소용돌이',
  },
  cross: {
    id: 'cross',
    name: '십자가',
    description: '부메랑처럼 날아갔다 돌아오는 십자가.',
    baseCooldown: 1.2,
    baseDamage: 15,
    baseProjectiles: 1,
    evolvesWith: 'clover',
  ...
  fire_wand: {
    id: 'fire_wand',
    name: '화염 지팡이',
    description: '랜덤 방향으로 적을 관통하는 화염구 발사.',
    baseCooldown: 1.5,
    baseDamage: 20,
    baseProjectiles: 1,
    evolvesWith: 'spinach',
  ...
  garlic: {
    id: 'garlic',
    name: '마늘',
    description: '주변의 모든 적에게 오라 데미지를 준다.',
    baseCooldown: 0.5,
    baseDamage: 5,
    baseProjectiles: 0,
...
export const PASSIVE_DEFS: Record<TPassiveId, TPassiveDef> = {
  spinach: {
    id: 'spinach',
    name: '시금치',
    description: '레벨당 공격력 +10%',
    effectPerLevel: 0.1,
  },
  armor: {
    id: 'armor',
    name: '갑옷',
    description: '레벨당 데미지 감소 +1',
    effectPerLevel: 1,
  },
  hollow_heart: {
    id: 'hollow_heart',
    name: '빈 심장',
    description: '레벨당 최대 HP +1',
    effectPerLevel: 1,
  },
  pummarola: {
    id: 'pummarola',
    name: '토마토',
    description: '레벨당 HP 회복 0.2/초',
    effectPerLevel: 0.2,
  },
  empty_tome: {
    id: 'empty_tome',
    name: '빈 마법서',
    description: '레벨당 쿨타임 -8%',
    effectPerLevel: 0.08,
  },
  bracer: {
    id: 'bracer',
    name: '팔찌',
    description: '레벨당 투사체 속도 +10%',
    effectPerLevel: 0.1,
  },
  clover: {
    id: 'clover',
    name: '네잎클로버',
    description: '레벨당 치명타 확률 +10%',
    effectPerLevel: 0.1,
  },
  attractorb: {
    id: 'attractorb',
    name: '자석 구슬',
    description: '레벨당 아이템 습득 범위 +25%',
    effectPerLevel: 0.25,
  },
  duplicator: {
    id: 'duplicator',
    name: '복제기',
    description: '레벨당 투사체 수 +1',
    effectPerLevel: 1,
  },
  candelabrador: {
    id: 'candelabrador',
    name: '촛대',
    description: '레벨당 범위 +10%',
    effectPerLevel: 0.1,
  },
};
