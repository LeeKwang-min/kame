...
export const MIN_ENEMY_SPEED = 150; // px/frame
export const MAX_ENEMY_SPEED = 270; // px/frame

// 난이도 조절
// 시작부터 많이 나오게 -> BASE_ENEMY_SPAWN_INTERVAL 줄이기
// 후반만 빡세게 하기 -> MIN_ENEMY_SPAWN_INTERVAL 줄이기 or lerp의 2번째값 줄이기
export const BASE_ENEMY_SPAWN_INTERVAL = 0.15; // 줄이면 시작 난이도에서 스폰 간격 빨라짐
export const MIN_ENEMY_SPAWN_INTERVAL = 0.07; // 줄이면 후반 최대 스폰 속도 빨라짐
