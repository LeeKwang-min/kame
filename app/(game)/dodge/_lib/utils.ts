...
export const BASE_ENEMY_SPAWN_INTERVAL = 0.9;
export const MIN_ENEMY_SPAWN_INTERVAL = 0.18;
...
export const getSpawnInterval = (t: number) => {
  ...
  return Math.max(
    ...
    lerp(BASE_ENEMY_SPAWN_INTERVAL, 0.18, d) // 0.22를 0.18에 가깝게 줄이면 스폰이 더 촘촘하게 됨
  );
};
